  ...
  return (
    <div className="fixed inset-0 z-50 lg:hidden">
      <div
        ...
        onClick={onClose}
      />
      <div className="absolute left-0 top-0 h-full w-72 bg-white shadow-2xl transform transition-transform duration-300 ease-out animate-in slide-in-from-left dark:bg-slate-900">
